...
rule humann2:
    ...
    output:
        gf = '{fs_prefix}/{df}/humann2__{params}__v3.0.0a/{db_nucl}__{db_protein}/{df_sample}/{preproc}/{df_sample}_genefamilies.tsv',
        pc = '{fs_prefix}/{df}/humann2__{params}__v3.0.0a/{db_nucl}__{db_protein}/{df_sample}/{preproc}/{df_sample}_pathcoverage.tsv',
        pa = '{fs_prefix}/{df}/humann2__{params}__v3.0.0a/{db_nucl}__{db_protein}/{df_sample}/{preproc}/{df_sample}_pathabundance.tsv'
    params:
        wd =     '{fs_prefix}/{df}/humann2__{params}__v3.0.0a/{db_nucl}__{db_protein}/{df_sample}/{preproc}/',
        merged = '{fs_prefix}/{df}/reads/{preproc}/{df_sample}.fastq.gz',
        s = '{fs_prefix}/{df}/reads/{preproc}/{df_sample}_S.fastq.gz',
    threads: 12
    shell: ('''conda activate humann3;\n 
            cat {input.r1} {input.r2} {params.s} > {params.merged}; \n 
